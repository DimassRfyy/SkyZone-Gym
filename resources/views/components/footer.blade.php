<footer class="flex flex-col w-full max-w-[1312px] mx-auto rounded-[32px] bg-black p-[120px] mt-[120px] mb-16">
    <div class="flex justify-between">
        <div class="flex flex-col gap-6 max-w-[306px] text-start">
            <img src="{{asset('assets/images/logos/logo-white.png')}}" class="h-12 w-fit" alt="icon">
        ...
        <nav class="flex gap-16 justify-end text-white">
            ...
            <ul class="flex flex-col gap-4">
                ...
                <li>
                    <a href="#" class="tracking-03">@SkyZone Gym.bodyfit</a>
                </li>
                <li>
                    <a href="#" class="tracking-03">admin@SkyZone Gym.com</a>
                </li>
            </ul>
        </nav>
    </div>
    ...
    <div class="flex items-center justify-between mt-[30px]">
        <p class="font-semibold tracking-03 text-white">© 2024 SkyZone Gym corporation</p>
